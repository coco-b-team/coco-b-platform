// Códigos de país (ISO 3166-1 alpha-2 + código telefónico) para el
// selector de teléfono del modal de reserva. La bandera se arma a partir
// del código de dos letras en vez de tipear ~150 emojis a mano — cada
// letra A-Z tiene un "regional indicator symbol" en Unicode a partir de
// U+1F1E6, y un par de esos symbols es lo que los sistemas renderizan
// como bandera.
...
export type CountryCode = { iso2: string; name: string; dial: string };
